            ...
            <div class="col-12 col-lg-4">
                <div class="single_widget_area">
                    ...
                    <div class="footer-logo mr-50">
                        <a href="../views/index.htmlphp"><img src="../src/public/image/core-img/logo2.png" alt=""></a>
                    </div>
                    <!-- Copywrite Text -->
                    <p class="copywrite">
                        ...
                        <nav class="navbar navbar-expand-lg justify-content-end">
                            ...
                            <div class="collapse navbar-collapse" id="footerNavContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="../views/product-details.php">Sản Phẩm</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../views/cart.php">Giỏ Hàng</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="../views/checkout.php">Thanh Toán</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
...
<script src="../src/public/js/jquery/jquery-2.2.4.min.js"></script>
<!-- Popper js -->
<script src="../src/public/js/popper.min.js"></script>
<!-- Bootstrap js -->
<script src="../src/public/js/bootstrap.min.js"></script>
<!-- Plugins js -->
<script src="../src/public/js/plugins.js"></script>
<!-- Active js -->
<script src="../src/public/js/active.js"></script>
