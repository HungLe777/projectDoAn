                        ...
                        <tbody>
                            <tr>
                                <td class="cart_product_img">
                                    <a href="#"><img src="../src/public/image/bg-img/cart1.jpg" alt="Product"></a>
                                </td>
                            ...
                            <tr>
                                <td class="cart_product_img">
                                    <a href="#"><img src="../src/public/image/bg-img/cart2.jpg" alt="Product"></a>
                                </td>
                                <td class="cart_product_desc">
                                        ...
                                        <div class="quantity">
                                            <span class="qty-minus"
                                                onclick="var effect = document.getElementById('qty2'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 1 ) effect.value--;return false;"><i
                                                    class="fa fa-minus" aria-hidden="true"></i></span>
                                            <input type="number" class="qty-text" id="qty2" step="1" min="1" max="300"
                                                name="quantity" value="1">
                                            <span class="qty-plus"
                            ...
                            <tr>
                                <td class="cart_product_img">
                                    <a href="#"><img src="../src/public/image/bg-img/cart3.jpg" alt="Product"></a>
                                </td>
                                <td class="cart_product_desc">
                                    <h5>Minimal Plant Pot</h5>
                                </td>
                                        ...
                                        <div class="quantity">
                                            <span class="qty-minus"
                                                onclick="var effect = document.getElementById('qty3'); var qty = effect.value; if( !isNaN( qty ) &amp;&amp; qty &gt; 1 ) effect.value--;return false;"><i
                                                    class="fa fa-minus" aria-hidden="true"></i></span>
                                            <input type="number" class="qty-text" id="qty3" step="1" min="1" max="300"
                                                name="quantity" value="1">
                                            <span class="qty-plus"
